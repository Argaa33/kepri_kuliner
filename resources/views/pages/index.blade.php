...
<body class="bg-[#c9d6e6] font-sans">
  ...
  <div class="flex min-h-screen">
    <aside class="w-16 bg-[#0e2d66] text-white flex flex-col items-center py-6 space-y-6">
      <a href="#" class="flex items-center" data-tooltip-target="tooltip-home">
        <svg class="w-6 h-6 mr-2" fill="currentColor" viewBox="0 0 24 24"><path d="M12 2L2 10h3v10h14V10h3L12 2z"/></svg>
        <span class="text-sm">Home</span>
      </a>
      <a href="#" class="flex items-center">
        <svg class="w-6 h-6 mr-2" fill="currentColor" viewBox="0 0 24 24"><path d="M12 21.35l-1.45-1.32C5.4 15.36 2 12.28 2 8.5 2 5.42 4.42 3 7.5 3c1.74 0 
      ...
      <a href="#" class="flex items-center">
        <svg class="w-6 h-6 mr-2" fill="currentColor" viewBox="0 0 24 24"><path d="M2 4v16h20V4H2zm2 2h16v12H4V6zm3 2v2h10V8H7z"/></svg>
        <span class="text-sm">Cart</span>
      </a>
      <a href="#" class="flex items-center">
        <svg class="w-6 h-6 mr-2" fill="currentColor" viewBox="0 0 24 24"><path d="M12 16a4 4 0 100-8 4 4 0 000 8zm8-4a8 8 0 11-16 
        0 8 8 0 0116 0z"/></svg>
        <span class="text-sm">Search</span>
      </a>
      <a href="#" class="flex items-center">
        <svg class="w-6 h-6 mr-2" fill="currentColor" viewBox="0 0 24 24"><path d="M12 12c2.7 0 4.8-2.1 
        4.8-4.8S14.7 2.4 12 2.4 7.2 4.5 7.2 
        7.2 9.3 12 12 12zm0 2.4c-3.2 0-9.6 
        1.6-9.6 4.8V22h19.2v-2.8c0-3.2-6.4-4.8-9.6-4.8z"/></svg>
