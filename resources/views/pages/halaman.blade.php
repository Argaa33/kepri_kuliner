...
<body class="bg-[#dde6f5] font-sans">
    ...
    <aside class="fixed left-0 top-0 h-screen w-14 bg-[#0e2c5e] flex flex-col items-center justify-between py-6">
        <div class="space-y-6 sidebar-icons">
            <a href="#"><img src="icons/home-white.svg" alt="Home" class="w-6 h-6"></a>
            <a href="#"><img src="icons/heart-white.svg" alt="Favorite" class="w-6 h-6"></a>
            <a href="#"><img src="icons/cart-white.svg" alt="Cart" class="w-6 h-6"></a>
            <a href="#"><img src="icons/message-white.svg" alt="Message" class="w-6 h-6"></a>
            <a href="#"><img src="icons/user-white.svg" alt="Profile" class="w-6 h-6"></a>
        </div>
    </aside>
