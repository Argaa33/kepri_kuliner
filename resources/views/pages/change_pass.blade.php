...
<head>
    <meta charset="UTF-8">
    <title>Change Password - Kuliner Riau</title>
...
<body class="bg-cover bg-center min-h-screen flex items-center justify-center" style="background-image: url('{{ asset('images/barelang.jpg') }}');">
    ...
    <div class="bg-white bg-opacity-60 backdrop-blur-md rounded-3xl shadow-lg p-10 w-[350px] sm:w-[400px]">
        <h2 class="text-2xl sm:text-3xl font-bold text-center text-black mb-6">CHANGE YOUR<br>PASSWORD</h2>
        ...
        <form method="POST">
            ...
            <div class="flex justify-between items-center">
                ...
                <a href="login" class="text-black hover:underline text-sm">Sign Up?</a>
            </div>
        </form>
    </div>
